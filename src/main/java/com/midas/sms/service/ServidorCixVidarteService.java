...
public class ServidorCixVidarteService {
    ...
    public PaginaContenidoDTO listarContenidoPaginado(String subRuta, String terminoBusqueda, String fechaDesde, String fechaHasta, int pagina, int tamano) {
        ...
        try {
            ...
            List<ArchivoSistemaDTO> page = (total > 0 && desde < hasta) ? todos.subList(desde, hasta) : new ArrayList<>();
    ...
    private String buildRutaCompleta(String subRuta) {
        if (subRuta == null || subRuta.isBlank()) return RUTA_BASE_MONITOR;
    ...
    private List<ArchivoSistemaDTO> mapEntries(Vector<ChannelSftp.LsEntry> entries, String terminoBusqueda, String fechaDesde, String fechaHasta) {
