...
public class ServidorCixMaryoryJoseyService {

    @Value("${asterisk.cix.maryory.josey.server.host}")
    private String remoteHost;

    @Value("${asterisk.cix.maryory.josey.server.user}")
    private String remoteUser;

    @Value("${asterisk.cix.maryory.josey.server.password}")
    private String remotePassword;

    @Value("${asterisk.cix.maryory.josey.server.port}")
