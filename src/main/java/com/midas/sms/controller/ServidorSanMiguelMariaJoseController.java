...
import com.midas.sms.service.ServidorSanMiguelMariaJoseService;
...
@RestController
@RequestMapping("/api/monitor-san-miguel-maria-jose")
@RequiredArgsConstructor
public class ServidorSanMiguelMariaJoseController {

    private final ServidorSanMiguelMariaJoseService service;
