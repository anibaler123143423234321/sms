...
import com.midas.sms.service.ServidorLosOlivosJulioDanielaService;
...
@RestController
@RequestMapping("/api/monitor-los-olivos-julio-daniela")
@RequiredArgsConstructor
public class ServidorLosOlivosJulioDanielaController {

    private final ServidorLosOlivosJulioDanielaService service;
