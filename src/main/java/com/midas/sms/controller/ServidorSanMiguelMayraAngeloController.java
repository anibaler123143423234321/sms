...
import com.midas.sms.service.ServidorSanMiguelMayraAngeloService;
...
@RestController
@RequestMapping("/api/monitor-san-miguel-mayra-angelo")
@RequiredArgsConstructor
public class ServidorSanMiguelMayraAngeloController {

    private final ServidorSanMiguelMayraAngeloService service;
