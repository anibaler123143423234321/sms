...
import com.midas.sms.service.ServidorCixJulcaService;
...
@RestController
@RequestMapping("/api/monitor-cix-julca")
@RequiredArgsConstructor
public class ServidorCixJulcaController {

    private final ServidorCixJulcaService service;
