...
import com.midas.sms.service.ServidorCixMaryoryJoseyService;
...
@RestController
@RequestMapping("/api/monitor-cix-maryory-josey")
@RequiredArgsConstructor
public class ServidorCixMaryoryJoseyController {

    private final ServidorCixMaryoryJoseyService service;
